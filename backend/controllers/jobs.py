...
from utils import load_jobs_from_content, sanitize_job
...
def job_stats(request):
    ...
    for i in range(30):
        ...
        applications_over_time.append({'date': str(day), 'count': daily_map.get(day, 0)})
...
def upload_csv(request):
    ...
    COMPARABLE_FIELDS = ['job_link', 'type_of_job', 'salary_annual', 'application_status', 'notes']
